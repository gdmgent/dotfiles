...
doskey artestead-s=cd %USERPROFILE%\Syllabi\artestead-doc\

rem Dotfiles
doskey dotfiles-c=cd %USERPROFILE%\Code\dotfiles\
doskey dotfiles-s=cd %USERPROFILE%\Syllabi\dotfiles-doc\

rem Crossmedia Publishing
doskey cmp=cd %USERPROFILE%\Code\cmp.local\
doskey cmp-s=cd %USERPROFILE%\Syllabi\cmp\
...
doskey ed-s=cd %USERPROFILE%\Syllabi\ed\

rem Mulimediatoepassingen
doskey mmtoep=cd %USERPROFILE%\Code\mmtoep.local\
doskey mmtoep-s=cd %USERPROFILE%\Syllabi\mmtoep\
...
doskey webd-s=cd %USERPROFILE%\Syllabi\webd\